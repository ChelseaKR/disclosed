...
site:
	$(PYTHON) -m disclosed.cli site --report data/report.json --national data/national.json --scorecard-census data/scorecard-census.json --receipts-from data/sample.json --snapshots-from data/snapshots --out site --generated $(shell date -u +%F)
