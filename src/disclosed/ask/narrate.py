...
- Drift records: state the source, the two snapshots, the field, and the direction word the record
  ...
  IPEDS with the College Scorecard, and never call an unmeasured field unchanged. rate_change is a change
  in the share of applicable institutions reporting; express it in percentage points.
