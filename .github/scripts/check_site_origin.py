...
3. No page makes a reference that escapes the site's own path, in either of the two forms it
   ...
   served from.
4. Every page has a non-empty title and description, and no two pages share either. 620 pages
   describing themselves identically is 620 pages a result list cannot tell apart.
